  ...
  return (
    <section className='about'>
      ...
      <div className='about-text'>
          ...
          <p className='fs-17'>LibraReads adalah sebuah website yang menyediakan koleksi buku yang dapat Anda baca secara online. Temukan berbagai judul menarik dari berbagai genre di perpustakaan digital kami. Nikmati pengalaman membaca yang menyenangkan dengan fitur unggulan kami, yaitu kemampuan untuk melihat preview yang jelas dari setiap buku sebelum Anda memutuskan untuk membacanya secara lengkap. Kami juga menawarkan fitur menarik lainnya, yaitu pilihan untuk memilih buku secara acak, memberikan kejutan menyenangkan setiap kali Anda ingin mengeksplorasi buku baru. Bergabunglah dengan kami dan jelajahi dunia pengetahuan dan hiburan melalui buku-buku digital kami yang menginspirasi.</p>
          <br /><br />
